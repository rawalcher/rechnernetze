...
class Producer extends Thread {
    public static final int PRODUCER_SUM_NUMBERS = 3;
    public static final int PRODUCER_MAX_VALUE = 2;
    ...
    {
        Random random = new Random();
        int countDown = PRODUCER_SUM_NUMBERS;
        synchronized (stack){
            while(true){
                ...
                if(countDown-num<=0){
                    stack.add(countDown);
                    stack.notifyAll(); //notify() would work too
...
public class ConsumerProducer {
    public static final int AMOUNT_CONSUMER = 3;
    public static final int AMOUNT_PRODUCER = 5;
    public static final int PRODUCER_MAX_NUMBER = 1000;
    public static void main(String[] args)
    {
        ...
        System.out.println("Sum should be: "+(AMOUNT_PRODUCER*PRODUCER_MAX_NUMBER));
    }
}