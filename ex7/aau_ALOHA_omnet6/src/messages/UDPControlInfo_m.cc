...
UDPControlInfo::UDPControlInfo(const char *name, short kind) : ::controlInfoIP(name, kind)
{
}

UDPControlInfo::UDPControlInfo(const UDPControlInfo& other) : ::controlInfoIP(other)
{
    copy(other);
}
...
UDPControlInfoDescriptor::UDPControlInfoDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(UDPControlInfo)), "controlInfoIP")
{
